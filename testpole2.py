...
class RewardFunction:
    ...
    def get_reward(self, image, episode, step):
        ...
        prompt = (
            ...
            #"Describe the image."
            "the image is about a pole sitting on a cart. Is the pole leaning left or right? Also output the degree that it's leaning. Be very precise, such as 81 degrees."
